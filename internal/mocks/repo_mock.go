...
// Source: github.com/Kiatsyndesi/api_tg_bot/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/Kiatsyndesi/api_tg_bot/internal/model"
...
func (m *MockEventRepo) Add(arg0 []model.PhonesEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.PhonesEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.PhonesEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
